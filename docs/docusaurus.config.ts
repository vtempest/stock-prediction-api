...
export default async function createConfig(options: any = {}) {
  ...
  return {
    ...
    favicon: "https://biogaseng.com/wp-content/uploads/2019/05/fav-150x150.jpg",
    projectName: "BioGasEng",
    presets: [
      [
        "classic",
        {
    ...
    themeConfig: {
      ...
      navbar: {
        title: name + " Docs",
          logo: {
            alt: "logo",
            src: "https://biogaseng.com/wp-content/uploads/2019/05/fav-150x150.jpg",
            href: "/functions",
          },
        items: [
          ...
          {
            to: "/research/Model%20Comparison",
            label: "🔬 Research",
            position: "left",
          },
